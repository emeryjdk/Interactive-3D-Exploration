...
//BCC atom
draw(shift(a/2,a/2,a/2)*scale(0.999*r,0.999*r,0.999*r)*unitsphere, color3, render);

//Labels and measures.
draw((0,a,0)--(0,a,a),red+linewidth(1));
//draw((a,0,0)--(0,a,0),red+linewidth(1));
...
//draw((a,0,0)--(0,a,a),red+linewidth(1));
label("$a$",(0,a,a/2),E,red);
//label("$\sqrt{2}a$",(a/2,a/2,0),S,red);
label("$r_0$",(a,r/2,0),S,black);
//label("$4r_0$",(a/2,a/2,a/2),SE,red);
label("$o$",(0,0,0),NW);
